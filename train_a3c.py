...
RANDOM_SEED = 42
RAND_RANGE = 1000
SUMMARY_DIR = './results_a3c'
LOG_FILE = './results_a3c/log'
TEST_LOG_FOLDER = './test_results_a3c/'
...
def testing(epoch, nn_model, log_file):
    ...
    # run test script
    os.system('python a3c_test.py ' + nn_model)
...
def central_agent(net_params_queues, exp_queues):
    ...
    with tf.compat.v1.Session() as sess, open(LOG_FILE + '_test', 'w') as test_log_file:
        ...
        TRAIN_SUMMARY_DIR = './results_a3c/' + curr_time + '/train'
        TEST_SUMMARY_DIR = './results_a3c/' + curr_time + '/test'
        ...
        saver = tf.compat.v1.train.Saver(max_to_keep=3)  # save neural net parameters
        ...
        while True:
            ...
            if epoch % MODEL_SAVE_INTERVAL == 0:
                ...
                test_avg_reward, test_avg_entropy = testing(epoch, SUMMARY_DIR + "/nn_model_ep_" + str(epoch) + ".ckpt",
                                                            test_log_file)
